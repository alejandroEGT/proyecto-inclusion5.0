...
<div class="row">
	<div class="col-md-offset-2 col-md-8 fondo-blanco">
		 <center>
			<img src="{{ '/'.$vendedor->foto }}" class="img-circle img-prod ">
						...
						<div class="col-md-12">
							...
							<div class="box-producto">
								<center>
									...
									<p><a href="{{ url($ruta.'/detalleProductoVendedor/'.base64_encode($producto->idProducto).'/'.base64_encode($vendedor->id)) }}" class="btn btn-primary btn-xs">Ver a</a>
