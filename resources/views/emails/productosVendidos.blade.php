...
<div class="row-fluid">
        ...
        <h1>Resumen de la compra</h1><br>
        <h4><a href="https://exod.cl/inicio_cliente">https://exod.cl/inicio_cliente</a></h4><br>
...
<div class="row-fluid">
    ...
    <tbody>
      <tr>
        <td><strong>{{ Session::get('producto') }}</strong></td>
        <td><strong>{{ Session::get('cantidad') }}</strong></td>
        <td><strong>{{'$'.number_format(Session::get('total'), 0, ',', '.') }} CLP</strong></td>
      </tr>
    </tbody>
  </table>
