...
<div class="row">
	<div class="col-md-offset-2 col-md-8 fondo-blanco">
		 <center>
			...
			<p><label class="lbl-" >{{ $alumno->nombre.' '.$alumno->apellidos }}</label></p>
			<hr>
		</center>	
	</div>
</div>
						...
						<div class="col-md-12">
							...
							<div class="box-producto">
								<center>
									...
									<p><a href="{{ url($ruta.'/detalleProducto/'.base64_encode($producto->idProducto).'/'.base64_encode($institucion_id)) }}" class="btn btn-primary btn-xs">Ver</a>
