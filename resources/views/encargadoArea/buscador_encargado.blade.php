						...
						<div class="centro1 col-md-offset-2 col-md-7 panel">
							@foreach ($vendedor as $v)
								<div class="row">
									...
									<div class="col-md-2">
									@if ($v->idrol == 1)
										<a href="{{ url("encargadoArea/perfil_ven/".base64_encode($v->iduser)."") }}" class="btn btn-default">Ver perfil 1</a>
									@endif
									@if ($v->idrol == 2)
										<a href="{{ url("encargadoArea/perfil_venInst/".base64_encode($v->iduser)."") }}" class="btn btn-default">Ver perfil 2</a>
									@endif
						...
						<div class="centro1 col-md-offset-2 col-md-7 panel">
							@foreach ($institucion as $i)
								<div class="row">
									...
									<div class="col-md-2">
										<a href="{{ url("encargadoArea/perfil_institucion/".base64_encode($i->id)."") }}" class="btn btn-default">Ver perfil</a>
									</div>
								</div>
							@endforeach
						</div>
